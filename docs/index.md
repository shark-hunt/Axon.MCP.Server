...
### 🏗 Architecture
- [Overview](architecture/overview.md) - System architecture and core components
- [Data Models](architecture/data_models.md) - Database schema and relationships
- [Infrastructure](architecture/infrastructure.md) - Deployment and scaling

### 📖 Guides
- [Setup Guide](guides/setup.md) - Prerequisites and installation
- [Development Guide](guides/development.md) - Dev environment setup and testing
...
### 🔌 API & Tools
- [REST API Reference](api/rest_api.md) - API endpoints and usage
- [MCP Tools Reference](api/mcp_tools.md) - MCP tools for AI assistants
...
### 3. Guidelines
* 📘 [Development Guide](guides/development.md) - Setup, coding standards, and best practices
